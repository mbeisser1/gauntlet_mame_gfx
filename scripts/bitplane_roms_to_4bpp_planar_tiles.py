...
This script reads eight Gauntlet EPROM files containing the motion object sprites,
combines them into four bit planes, and writes a single interleaved tile data file
suitable for tools that expect 8x8 tiles with 4 planes per row. Tile data is written
sequentially.
